 ...
 *
 */
public class SixtyFourByOneByteRandomAccessMemory implements
		ISixtyFourByOneByteRandomAccessMemory {

	private IThreeToEightDecoder w = new ThreeToEightDecoder();
	
	private IEightByOneByteRandomAccessMemory bank0 = new EightByOneByteRandomAccessMemory();
	private IEightByOneByteRandomAccessMemory bank1 = new EightByOneByteRandomAccessMemory();
	private IEightByOneByteRandomAccessMemory bank2 = new EightByOneByteRandomAccessMemory();
	private IEightByOneByteRandomAccessMemory bank3 = new EightByOneByteRandomAccessMemory();
	private IEightByOneByteRandomAccessMemory bank4 = new EightByOneByteRandomAccessMemory();
	private IEightByOneByteRandomAccessMemory bank5 = new EightByOneByteRandomAccessMemory();
	private IEightByOneByteRandomAccessMemory bank6 = new EightByOneByteRandomAccessMemory();
	private IEightByOneByteRandomAccessMemory bank7 = new EightByOneByteRandomAccessMemory();
