...
public class InverterTest {
	...
	public void setUp() throws Exception {
		systemUnderTest = new electroMechanicalLogic.Inverter();
	}
	...
	@Test
	public void test_GetOutput_WhenPowerAndInputAreOn_ReturnsFalse() {
	...
	@Test
	public void test_GetOutput_WhenPowerIsOnAndInputIsOff_ReturnsTrue() {
		systemUnderTest.setPower(true);
		systemUnderTest.setInput(false);
		systemUnderTest.step();
